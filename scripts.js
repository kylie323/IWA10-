...
const correctDate = new Date(copied.date); //copied.date.setHours(0,0,0,0), why does this return false?
...
if (isEarlier) copied.date = correctDate;
console.log("ID change:", holidays[christmas].id !== copied.id); // removed || copied.id as = 6
console.log(
  "Name change:",
...
const firstDay = new Date(firstHolidayTimestamp)
  ...
  .padStart(2, 0);
const firstMonth =
  new Date(firstHolidayTimestamp).getMonth().toString().padStart(1, 1) + 1;
const lastDay = new Date(lastHolidayTimestamp).getDate();
const lastMonth = new Date(lastHolidayTimestamp).getMonth() + 1; // why were dates incorrect
